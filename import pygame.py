...
assets['crocodilo_img'] = pygame.image.load('assets/img/crocodilo_jogo_da_velha.png').convert_alpha()
assets['crocodilo_img'] = pygame.transform.scale(assets['crocodilo_jogo_da_velha.png'], (CROCODILO_WIDTH,CROCODILO_HEIGHT))
